	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equalsIgnoreCase("updateReservation")) {
			...
			if (homestay.getHomestayId() != 0) {
				...
				System.out.println("date skrg :"+datenow);
				request.setAttribute("datenow", datenow);
				request.setAttribute("done", "doneupdate");
			...
			if (Scid.equalsIgnoreCase("null")) {
			    ...
			    String checkindate = sdf.format(dateCin);
			    System.out.println("String check in date: "+checkindate);
			    String checkoutdate = sdf.format(dateCout);
			    
				request.setAttribute("checkindate", checkindate);
				System.out.println("123"+cin);
				request.setAttribute("checkoutdate", checkoutdate);
				System.out.println("123"+cout);
				forward = "login.jsp";
			}
