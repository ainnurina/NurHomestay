...
public class HomestayController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		} else if (action.equalsIgnoreCase("listallhomestay2")) {
			forward = "rumahinfo.jsp";
			request.setAttribute("homestays", daoHomestay.getAllHomestay());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equalsIgnoreCase("addBranch")) {
		    ...
		    String incheckin = sdf2.format(dateCin);
		    System.out.println("String check in date:"+incheckin);
		    String incheckout = sdf2.format(dateCout);
        	...
        	request.setAttribute("initialCheckin", incheckin); //for initialize search input value
        	request.setAttribute("initialCheckout", incheckout); //for initialize search input value
        	request.setAttribute("priceFormatter", priceFormatter);
