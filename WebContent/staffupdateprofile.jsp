                  ...
                  <div class="column-1">
                      ...
                      <table>
                          ...
                          <tr>
                              ...
                              <td class="double-dot">:</td>
                              <td><input name="sta_phoneNo" type="number" class="form-control" placeholder="Email" value="<c:out value="${staff.sta_phoneNo}" />" required></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                              ...
                              <td class="double-dot">:</td>
                              <td><input name="sta_email" type="email" class="form-control"  placeholder="Email" value="<c:out value="${staff.sta_email}" />" required></td>
                          </tr>
                      </table>
                      <br/><br/><br/><br/>
    ...
    <!-- Scripts -->
      ...
      <script>
        ...
        for (i = 0; i < dropdown.length; i++) {
          ...
          dropdownContent.style.display = "bloc
          k";
          }
          });
        }
