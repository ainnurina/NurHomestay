...
<html lang="en">
  ...
  <head>
    ...
    <script type="text/javascript">
	    ...
	    element.valueAsNumber = <c:out value="${checkindate}" />;
    </script>
  </head>
              ...
              <div class="container-fluid">
                <form id="form-book" action="HomestayController?action=checkAvailable" method="post">
                    <div class=" nak-row-gak">
                      Check-in<br>
                      <input class="bolehla" type="date" name="checkindate" value="<c:out value="${initialCheckin}" />" min="2021-07-13" required/>
                    </div>
                    <div class=" nak-row-gak">
                      Check-out<br>
                      <input class="bolehla"  type="date" name="checkoutdate" value="<c:out value="${initialCheckout}" />" min="2021-07-14" required/>
                    </div>
