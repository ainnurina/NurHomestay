                  ...
                  <div class="column-1">
                      ...
                      <table>
                          ...
                          <tr>
                              ...
                              <td class="double-dot">: </td>
                              <td><input name="home_deposit" type="number" class="form-control" id="home_deposit" placeholder="home_deposit" required="required"></td>
                          </tr>
                          <tr>
                              <td class="labelsize"><label>Price (RM)</label></td>
                              <td class="double-dot">: </td>
                              <td><input name="home_price" type="number" class="form-control" id="home_price" placeholder="home_price" required="required"></td>
                          </tr>
                      </table>
                      <br><br>
