                  ...
                  <div class="column-1">
                      ...
                      <table >
                          <tr>
                              ...
                              <td><input name="homestayId" required="" type="text" class="form-control" id="homestayId"  value="<c:out value="${homestay.homestayId}" />" readonly/ ></td>
                          </tr>
                          <tr>
                              <td class="labelsize"><label>Branch Name</label></td>
                              <td class="double-dot">:</td>
                              <td><input name="home_name" required="" type="text" class="form-control" id="home_name"  value="<c:out value="${homestay.home_name}" />" /></td>
                          </tr>
                          <tr>
                              <td class="labelsize"><label>Address</label></td>
                              <td class="double-dot">:</td>
                              <td><textarea name="home_address" required="" id="home_address" placeholder="home_address" rows="6"><c:out value="${homestay.home_address}" /></textarea></td>
                          </tr>
                          <tr>
                            <td class="labelsize"><label>Description</label></td>
                            <td class="double-dot">:</td>
                            <td><textarea name="home_desc" required="" id="home_desc" placeholder="home_desc" rows="6"><c:out value="${homestay.home_desc}" /></textarea></td>
                        </tr>
                         <tr>
                              <td class="labelsize"><label>Deposit (RM)</label></td>
                              <td class="double-dot">:</td>
                              <td><input name="home_deposit" required="" type="number" class="form-control" id="home_deposit" value="<c:out value="${homestay.home_deposit}" />"></td>
                          </tr>
                          <tr>
                              <td class="labelsize"><label>Price (RM)</label></td>
                              <td class="double-dot">:</td>
                              <td><input name="home_price" required="" type="number" class="form-control" id="home_price" value="<c:out value="${homestay.home_price}" />"></td>
                          </tr>
                      </table>
                      <br><br>
