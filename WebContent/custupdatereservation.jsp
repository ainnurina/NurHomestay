                        	...
                        	<td>
				                <form name="update" id="form-book" action="HomestayController?action=checkAvailable2" method="post">
				                    ...
				                    <div class=" nak-row-gak">
				                      Check-in<br>
				                      <input class="bolehla"  type="date" name="checkindate" placeholder="1" min="2021-07-06" required/>
				                    </div>
				                    <div class=" nak-row-gak">
				                      Check-out<br>
				                      <input class="bolehla"  type="date" name="checkoutdate" placeholder="1"  min="2021-07-07" required/>
				                    </div>
